document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('/analyze/all_data')
        ...
        .then(data => {
            ...
            var SOS = setupChart(chartInfo1, '求救', sosData, 'rgba(255, 38, 38, 0.8)', 'rgba(255, 38, 38, 0.8)');
            ...
            var Memo = setupChart(chartInfo2, '新增', memoData, 'rgba(38, 97, 255, 0.8)', 'rgba(38, 97, 255, 0.8)');
